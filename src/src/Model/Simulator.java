 ...
 * 
 * Modified by Letao WANG
 * 2 parametres : direction and robotStart
 * 1 method : simulateOneStep()
 *
 */
public class Simulator {
	...
	/** Whether the robot controlled by the player can move */
	 ...
	 * startSimulation).
	 * 
	 * if this agent is Robot and robotStart is false ( keyReleased ), Robot doesn't move
	 */
